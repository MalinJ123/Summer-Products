...
const AdminUser = ({ addUsers }) => {
  console.log("AddUsers innehåller", addUsers);
  //AddUsers innehåller undefined. 
  //oneUser innehåller shopid, registerUsername, och registerPassword. Men infon försvinner i getUser/addUser
  //map()kan inte ut värder, eftersom den står som undefined, alltså tom. 
	...
	<>
	  <section className="Admin-body">
		 ...
		 <div className="AdminUsers">
			{products.map(({ id, registerUsername, registerPassword }) => (
			  <div key={id}>
				 <p className="title">Alla Användare:</p>
				 <p className="">Användare: {registerUsername}</p>
				 <p>Lösenord: {registerPassword}</p>
				 <div className="deleteUserBtn-container">
			<button onClick={showGetUser}>showGetUser</button>
